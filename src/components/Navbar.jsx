...
//               {/* ঐচ্ছিক: লোগোর নিচে ছোট টেক্সট যদি দিতে চান তবে এটি আনকমেন্ট করুন */}
//               {/* <p className="text-[8px] lg:text-[10px] font-black tracking-[0.4em] text-[#1B2532] uppercase mt-1 opacity-80 group-hover:text-[#E11D48] transition-colors">
//       Rent A Car
//     </p> 
//     */}
//             </div>
...
//                 key={link.name}
//                 href={link.href}
//                 className={`text-[13px] font-black tracking-widest transition-colors ${link.active ? 'text-[#E11D48]' : 'text-[#1B2532] hover:text-[#E11D48]'
//                   }`}
//               >
//                 {link.name}
//               </a>
...
//       {/* --- Mobile Sidebar --- */}
//       <div
//         className={`fixed inset-0 bg-white z-[110] transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
